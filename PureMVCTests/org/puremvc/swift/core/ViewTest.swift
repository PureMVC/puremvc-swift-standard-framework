...
public class ViewTest: XCTestCase {
    ...
    */
    func testRegisterAndRemoveMediator() {
        ...
        let removedMediator: IMediator = view.removeMediator("testing") as IMediator!
    ...
    */
    ...
    func testRegisterAndRemoveObserver() {
        ...
        view.registerObserver("test", observer: Observer(notifyMethod: {[weak self] notification in self?.handleNotification(notification: notification); return}, notifyContext: self))
